...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@fit-buddy.q9mdh.mongodb.net/?retryWrites=true&w=majority&appName=Fit-buddy`;
...
app.get('/', (req, res) => {
    res.send('Fit-buddy Server is running!');
})
